...
import { ArrowLeft, BookOpen, Shield, Box, ShoppingCart, Truck, Settings } from 'lucide-react';
...
export default function UserGuidePage() {
    return (
        <div className="min-h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100">
            {/* Navigation Bar */}
            <nav className="fixed top-0 inset-x-0 h-16 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md border-b border-neutral-200 dark:border-neutral-800 z-50 flex items-center justify-between px-6">
                <div className="flex items-center gap-4">
                    <Link href="/" className="p-2 hover:bg-neutral-100 dark:hover:bg-neutral-900 rounded-full transition-colors" title="Back to Home">
                ...
                <div className="hidden md:flex gap-6 text-sm font-medium text-neutral-500 dark:text-neutral-400">
                    <a href="#getting-started" className="hover:text-[#2E8B57] transition-colors">Getting Started</a>
                    <a href="#dashboard" className="hover:text-[#2E8B57] transition-colors">Dashboard</a>
                    <a href="#stock-movement" className="hover:text-[#2E8B57] transition-colors">Stock Movement</a>
                    <a href="#po" className="hover:text-[#2E8B57] transition-colors">Purchase Orders</a>
                    <a href="#admin" className="hover:text-[#2E8B57] transition-colors">Admin</a>
                </div>
            </nav>
